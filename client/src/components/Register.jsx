...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-[url('././images/register_page_bg.jpg')] flex items-center justify-center">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md opacity-85 relative">
        {/* Close Button */}
        <Link
          to="/"
